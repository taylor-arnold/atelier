...
<div class="lang-switcher">
  <a href="index_en.html" title="English version">🇬🇧</a>
...
[Solutions d'exercice](atelier_exercices_fr.html)
...
- [*Foundations of Data Science*](https://taylor-arnold.github.io/fds-py/)
Livre accèsible (CC-BY) en anglais qui explique les méthodes de la science de données dans Python.
- Les aides-mémoirs :
...
suivre, vous pouvez [télécharger R](https://cran.r-project.org/), [RStudio](https://posit.co/downloads/), et les exemples et données ci-dessous dans votre propre ordinateur.

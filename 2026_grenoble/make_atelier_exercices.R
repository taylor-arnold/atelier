strip_solutions <- function(input, output) {
...
strip_solutions("atelier_exercices_solutions_fr.Rmd", "atelier_exercices_fr.Rmd")
strip_solutions("atelier_exercices_solutions_en.Rmd", "atelier_exercices_en.Rmd")

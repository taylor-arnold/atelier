...
\splitcols{%
  Ces diapositives accompagnent les tutoriels Python que nous avons conçus pour introduire les fondements théoriques et méthodologiques du distant viewing, ainsi qu'un aperçu des outils du Python.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{rightframe}{Distant Viewing : Outils générals}
\splitcols{%
...
\splitcols{%
  ...
  Notez qu'il y a beaucoup de lumière verte ici, alors même que rien dans l'image originale n'est ce qu'on appellerait habituellement « vert ». 
}{%
  \imgcaption{media/imageB.png}{Visualisation des pixels verts.}
}
\end{rightframe}
...
\begin{rightframe}{Lumière RGB}
\splitcols{%
  Le vert se mélange au rouge et au bleu pour produire d'autres couleurs comme le marron, l'orange ou le blanc.
}{%
  \imgcaption{media/image12.jpg}{Visualisation des pixels rouges, verts et bleus.}
}
\end{rightframe}
